...
public class ImagePickerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent == null) {
            Toast.makeText(this, "Image picker option is missing!", Toast.LENGTH_SHORT).show();
            return;
        }
    ...
    public static void showImagePickerOptions(Context context, PickerOptionListener listener) {
        ...
        // add a list
        String[] cards = {context.getString(R.string.lbl_take_camera_picture), context.getString(R.string.lbl_choose_from_gallery)};
        builder.setItems(cards, (dialog, which) -> {
            switch (which) {
                case 0:
